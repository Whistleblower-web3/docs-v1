...
Truth Box Market 的生态系统依赖于多方角色的协作博弈。为了确保系统的去中心化与抗审查性，我们设计了精细的权限分离与激励机制。

## 1. 生态关键角色 (Roles)

- **Minter**：Truth Box 创建者，即吹哨者。
- **Seller**：代理出售Box的其它用户。
- **Buyer**：支付购买/竞拍 Truth Box的用户。
- **Bidder**: 参与竞拍但是失败的用户。
...
> 这里再次说明：Truth Box 交易的是访问权限，而不是像NFT那样会交易Box本身。
