...
description: Thank you to the teams, partners, and community contributing to Evidence Market.
sidebar:
  order: 23
---
...
- **Open Source and Cryptography Communities**: Evidence Market is a product standing on the shoulders of giants. Thank you to all the open-source components, underlying encryption algorithms (AES, ECDH), and the Ethereum developer community we used in the building process.
